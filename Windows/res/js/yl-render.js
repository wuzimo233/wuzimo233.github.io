    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("Xianqi's Windows", 'Hello，同志，欢迎来到 Zimo的小分站！<br/>个人主页：' + '<a style="color: white" target="_blank" href="http://ze520.cn/">ze520.cn </a><br />本网站 UI 由 ' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动<p>欢迎使用支付宝扫描二维码对作者进行捐赠~<br/><br/><img style="width: 100%" src=""/ alt="二维码"></p>');
            }, 1500)
          });
        }
